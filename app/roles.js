...
exports.get = name => {
    ...
    mobs[name] = [
        {name: "driver", level: 1, count: 0},
        {name: "navigator", level: 1, count: 0},
        {name: "mobber", level: 1, count: 0},
        {name: "researcher", level: 2, count: 0},
        {name: "sponsor", level: 2, count: 0},
        {name: "rear-admiral", level: 2, count: 0},
        {name: "archivist", level: 3, count: 0},
        {name: "automationist", level: 3, count: 0},
        {name: "nose", level: 3, count: 0},
        {name: "traffic-cop", level: 4, count: 0}
    ];
    return mobs[name];
}
